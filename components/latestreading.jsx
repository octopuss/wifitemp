...
var LatestReading = React.createClass({
    ...
    getInitialState: function () {
        return {
            readingValue: 0,
            readingDimension: ChartEnums[ChartConstants.READING_DIMENSION_CELSIUS],
            pending: false
        };
    },
    ...
    changeHandler: function () {
        ...
        this.setState({
            readingValue: Number(lr.value).toFixed(ChartEnums[ChartConstants.READING_PRECISION]),
            readingDimension: lr.valueDimension
        });
